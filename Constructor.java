...
public class Constructor
{
	public static void main(String [] args)
	{
		...
		ConstructorTest getValues = new ConstructorTest();
		evenOrOdd = getValues.EvenOrOdd(); //allows us to get a result from the constructor test file
